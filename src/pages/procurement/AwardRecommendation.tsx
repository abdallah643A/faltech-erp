...
const config: ERPModulePageConfig = {
  ...
  description: 'Recommend vendor for procurement award',
  businessPurpose: 'Document recommendation with justification for approval',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Requires approval before PO',
  module: 'procurement',
