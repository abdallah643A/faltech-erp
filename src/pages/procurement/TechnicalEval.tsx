...
const config: ERPModulePageConfig = {
  ...
  description: 'Evaluate supplier technical capability',
  businessPurpose: 'Score suppliers on specifications, compliance, delivery, and certifications',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Separated from commercial evaluation',
  module: 'procurement',
