...
const config: ERPModulePageConfig = {
  ...
  description: 'Long-term vendor agreements',
  businessPurpose: 'Manage negotiated pricing, quantity limits, and release order terms',
  financeEffect: 'commitment_only',
  financeEffectDescription: 'No immediate journal. Defines release order framework',
  module: 'procurement',
