...
const config: ERPModulePageConfig = {
  ...
  description: 'Evaluate supplier commercial offers',
  businessPurpose: 'Compare price, tax, freight, terms, and compute weighted scoring',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Feeds award recommendation',
  module: 'procurement',
