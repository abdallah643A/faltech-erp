...
const config: ERPModulePageConfig = {
  ...
  description: 'Strategic sourcing planning',
  businessPurpose: 'Convert budget, project demand, and forecast into sourcing plan',
  financeEffect: 'none',
  financeEffectDescription: 'No journal. Drives timing of RFQs and package strategy',
  module: 'procurement',
  documentType: 'Sourcing Plan',
