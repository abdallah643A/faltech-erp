...
const config: ERPModulePageConfig = {
  ...
  description: 'Demand forecasting for production',
  businessPurpose: 'Forecast production requirements based on sales forecast and inventory policy',
  financeEffect: 'forecast_only',
  financeEffectDescription: 'No journal. Drives MRP and production planning',
