...
const config: ERPModulePageConfig = {
  ...
  businessPurpose: 'Generate purchase recommendations based on min/max, lead time, and demand',
  financeEffect: 'none',
  financeEffectDescription: 'No journal. Planning recommendations for procurement',
  module: 'inventory',
