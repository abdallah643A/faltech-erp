...
const config: ERPModulePageConfig = {
  ...
  description: 'Stock value by item and warehouse',
  businessPurpose: 'Current inventory value by valuation method with reconciliation to GL',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Financial reconciliation report',
  module: 'inventory',
  documentType: 'Report',
