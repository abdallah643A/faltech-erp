...
const config: ERPModulePageConfig = {
  ...
  description: 'Post inventory count variances',
  businessPurpose: 'Create adjustment entries from physical count differences',
  financeEffect: 'stock_value',
  financeEffectDescription: 'Dr/Cr Inventory and corresponding gain/loss account',
  financeRegistryKey: 'inventory_posting',
  module: 'inventory',
