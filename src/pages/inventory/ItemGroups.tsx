...
const config: ERPModulePageConfig = {
  title: 'Item Groups',
  description: 'Item classification and grouping',
  businessPurpose: 'Manage item groups that control valuation method, accounts, and planning defaults',
  financeEffect: 'none',
  financeEffectDescription: 'No journal. Controls account determination for inventory transactions',
  module: 'inventory',
  documentType: 'Item Group',
