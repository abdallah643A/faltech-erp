...
const config: ERPModulePageConfig = {
  ...
  description: 'Comprehensive inventory audit trail',
  businessPurpose: 'Full transaction history by item with quantity and value movements',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Audit and compliance reporting',
  module: 'inventory',
  documentType: 'Report',
