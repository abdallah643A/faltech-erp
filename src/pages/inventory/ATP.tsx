...
const config: ERPModulePageConfig = {
  ...
  description: 'Stock availability check for sales',
  businessPurpose: 'Calculate available quantity considering on-hand, committed, and incoming supply',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Supports order promising',
  module: 'inventory',
  documentType: 'ATP Check',
