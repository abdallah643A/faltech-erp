...
const config: ERPModulePageConfig = {
  title: 'Receivable Aging by Project',
  description: 'AR aging analysis by construction project',
  businessPurpose: 'Detailed aging of receivables by project, client, and billing type',
  financeEffect: 'none',
