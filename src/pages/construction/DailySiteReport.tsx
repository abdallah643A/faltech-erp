...
const config: ERPModulePageConfig = {
  ...
  description: 'Comprehensive daily site activity report',
  businessPurpose: 'Capture daily progress, manpower, equipment, materials, weather, issues, and instructions',
  financeEffect: 'none',
  financeEffectDescription: 'No direct journal. May trigger labor allocation and equipment usage cost updates',
  module: 'construction',
