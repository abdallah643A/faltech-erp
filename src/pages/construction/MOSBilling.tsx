...
const config: ERPModulePageConfig = {
  title: 'Material on Site Billing',
  description: 'Bill for materials delivered to site but not yet installed',
  businessPurpose: 'Include material on site value in progress billing with appropriate controls',
  financeEffect: 'none',
  financeEffectDescription: 'No journal at MOS stage. Included in progress billing invoice',
  module: 'construction',
  documentType: 'MOS Claim',
