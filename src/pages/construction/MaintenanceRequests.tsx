...
const config: ERPModulePageConfig = {
  ...
  description: 'Equipment maintenance and repair requests',
  businessPurpose: 'Log maintenance needs, schedule repairs, track downtime and costs',
  financeEffect: 'none',
  financeEffectDescription: 'No journal at request. AP invoice for repairs creates project cost',
  module: 'construction',
