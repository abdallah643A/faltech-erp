...
const config: ERPModulePageConfig = {
  ...
  description: 'Breakdown of contract value by trade, package, and activity',
  businessPurpose: 'Detailed decomposition of contract value for billing and cost control purposes',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Drives billing and cost allocation structure',
  module: 'construction',
