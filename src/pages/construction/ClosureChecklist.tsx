...
const config: ERPModulePageConfig = {
  ...
  description: 'Complete project closure process',
  businessPurpose: 'Verify all commercial, operational, and financial items resolved before closure',
  financeEffect: 'none',
  financeEffectDescription: 'No direct journal. Gates financial closure and archiving',
  module: 'construction',
