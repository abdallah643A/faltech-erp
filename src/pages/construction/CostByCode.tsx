...
const config: ERPModulePageConfig = {
  title: 'Cost by Cost Code',
  description: 'Cost analysis by cost code structure',
  businessPurpose: 'Breakdown of budget, commitment, actual, and forecast by cost code',
  financeEffect: 'none',
