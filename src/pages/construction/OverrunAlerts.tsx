...
const config: ERPModulePageConfig = {
  title: 'Overrun Alerts',
  description: 'Cost overrun early warning system',
  businessPurpose: 'Automated alerts for budget exceedance, commitment overruns, and negative trends',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Triggers management action',
  module: 'construction',
  documentType: 'Alert',
