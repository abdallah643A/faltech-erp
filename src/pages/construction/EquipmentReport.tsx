...
const config: ERPModulePageConfig = {
  ...
  description: 'Equipment cost analysis by project',
  businessPurpose: 'Breakdown of equipment costs by owned, rented, fuel, and maintenance',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Analytical report',
  module: 'construction',
  documentType: 'Report',
