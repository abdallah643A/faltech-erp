...
const config: ERPModulePageConfig = {
  title: 'Tender BOQ',
  description: 'Bill of Quantities for tender pricing',
  businessPurpose: 'Manage BOQ line items with quantities, UOM, descriptions, trade codes, and cost codes',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Feeds into estimation workbook',
  module: 'construction',
  documentType: 'BOQ Line',
