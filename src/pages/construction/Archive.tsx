...
const config: ERPModulePageConfig = {
  ...
  description: 'Archive closed project records',
  businessPurpose: 'Move closed project to archive status, freeze all postings, generate final reports',
  financeEffect: 'none',
  financeEffectDescription: 'Closes project to new postings. Archives documents',
  module: 'construction',
