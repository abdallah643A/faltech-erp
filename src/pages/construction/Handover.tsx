...
const config: ERPModulePageConfig = {
  ...
  description: 'Project handover documentation and checklist',
  businessPurpose: 'Structured handover process with document submission and acceptance tracking',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Gates practical completion certificate',
  module: 'construction',
