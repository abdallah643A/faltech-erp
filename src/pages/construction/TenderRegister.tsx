...
const config: ERPModulePageConfig = {
  ...
  description: 'Central register of all tenders and bids',
  businessPurpose: 'Maintain a complete register of all tender invitations, submissions, and outcomes',
  financeEffect: 'none',
  financeEffectDescription: 'No direct journal. Updates bid pipeline and forecast metrics',
  financeRegistryKey: 'tender_register',
  module: 'construction',
  documentType: 'Tender',
