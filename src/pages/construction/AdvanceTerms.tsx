...
const config: ERPModulePageConfig = {
  ...
  description: 'Client and subcontractor advance payment rules',
  businessPurpose: 'Configure advance payment amounts, recovery schedules, and guarantee requirements',
  financeEffect: 'none',
  financeEffectDescription: 'No journal at setup. Controls advance billing and recovery logic',
  module: 'construction',
  documentType: 'Advance Terms',
