...
const config: ERPModulePageConfig = {
  ...
  description: 'Monthly project performance report',
  businessPurpose: 'Comprehensive monthly report with earned value, cost, billing, and forecast updates',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Feeds client reporting and management review',
  module: 'construction',
