...
const config: ERPModulePageConfig = {
  title: 'BOQ Import',
  description: 'Import Bill of Quantities from external sources',
  businessPurpose: 'Import BOQ data from Excel, CSV, or industry formats into the estimation system',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Creates BOQ structure for estimation',
  module: 'construction',
  documentType: 'BOQ',
