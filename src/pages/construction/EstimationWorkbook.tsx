...
const config: ERPModulePageConfig = {
  title: 'Estimation Workbook',
  description: 'Comprehensive cost estimation for tenders',
  businessPurpose: 'Build detailed cost estimates from material, labor, equipment, subcontract, overhead, risk, and markup',
  financeEffect: 'forecast_only',
  financeEffectDescription: 'No journal. Updates pipeline forecast, estimated revenue, and expected margin',
  module: 'construction',
