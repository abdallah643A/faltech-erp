...
const config: ERPModulePageConfig = {
  title: 'EOT Requests',
  description: 'Extension of Time requests and tracking',
  businessPurpose: 'Submit and track extension of time requests with supporting documentation',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. May adjust milestone dates and forecast',
  module: 'construction',
  documentType: 'EOT Request',
