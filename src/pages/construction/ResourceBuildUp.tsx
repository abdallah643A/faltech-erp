...
const config: ERPModulePageConfig = {
  title: 'Resource Build-Up',
  description: 'Resource-based cost build-up for estimation',
  businessPurpose: 'Define resource requirements and rates for each BOQ item including labor, material, equipment',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Drives estimation accuracy',
  module: 'construction',
  documentType: 'Resource Build-Up',
