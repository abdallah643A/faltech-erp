...
const config: ERPModulePageConfig = {
  ...
  description: 'Full movement visibility by batch/serial',
  businessPurpose: 'Track material from receipt through issue to final use with quality traceability',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Critical for quality and compliance',
  module: 'construction',
  documentType: 'Trace Record',
