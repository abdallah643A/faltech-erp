...
const config: ERPModulePageConfig = {
  title: 'Subcontract Liability Report',
  description: 'Outstanding subcontractor obligations',
  businessPurpose: 'Report of subcontract values, certified, paid, retention held, and balance due',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Shows subcontract exposure',
  module: 'construction',
  documentType: 'Report',
