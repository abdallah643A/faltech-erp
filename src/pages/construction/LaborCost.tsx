...
const config: ERPModulePageConfig = {
  ...
  description: 'Allocate labor costs to projects and cost codes',
  businessPurpose: 'Map payroll expenses to projects, activities, and cost codes based on timesheets',
  financeEffect: 'project_cost',
  financeEffectDescription: 'Creates labor cost entries against project cost codes',
  financeRegistryKey: 'labor_cost',
  module: 'construction',
