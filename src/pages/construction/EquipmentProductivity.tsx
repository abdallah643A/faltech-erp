...
const config: ERPModulePageConfig = {
  title: 'Equipment Productivity Analysis',
  description: 'Analyze equipment utilization and productivity',
  businessPurpose: 'Compare planned vs actual hours, utilization rates, and cost per unit of output',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Analytical reporting',
  module: 'construction',
