...
const config: ERPModulePageConfig = {
  ...
  description: 'Master contract record for construction project',
  businessPurpose: 'Central contract record linking client, value, scope, milestones, payment terms, and conditions',
  financeEffect: 'none',
  financeEffectDescription: 'No journal. Defines revenue and billing baseline',
  module: 'construction',
