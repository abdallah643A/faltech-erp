...
const config: ERPModulePageConfig = {
  title: 'Goods Receipt to Project',
  description: 'Receive materials directly to project site',
  businessPurpose: 'Record material receipt at site warehouse with project and cost code tagging',
  financeEffect: 'stock_value',
  financeEffectDescription: 'Dr Inventory / Cr GR-IR Clearing. Updates project committed-to-actual material cost',
  module: 'construction',
