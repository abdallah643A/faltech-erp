...
const config: ERPModulePageConfig = {
  title: 'Claim Valuation',
  description: 'Assess financial value of claims',
  businessPurpose: 'Calculate quantum of claims including prolongation, disruption, and acceleration costs',
  financeEffect: 'none',
  financeEffectDescription: 'No journal. Updates claim register value and expected recovery',
  financeRegistryKey: 'claim_valuation',
  module: 'construction',
