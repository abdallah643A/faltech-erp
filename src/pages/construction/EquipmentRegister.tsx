...
const config: ERPModulePageConfig = {
  ...
  description: 'Master register of owned and rented equipment',
  businessPurpose: 'Track equipment details, ownership, rental terms, depreciation, and availability',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect at registration. Drives equipment cost allocation',
  module: 'construction',
