...
const config: ERPModulePageConfig = {
  title: 'WBS / Activity Structure',
  description: 'Work Breakdown Structure for project planning',
  businessPurpose: 'Hierarchical WBS with activities, durations, dependencies, and resource assignments',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Drives scheduling and cost allocation',
  module: 'construction',
  documentType: 'WBS Element',
