...
const config: ERPModulePageConfig = {
  ...
  description: 'Complete register of all project variations',
  businessPurpose: 'Track all variations with status, value, approval, and billing status',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Master register',
  module: 'construction',
