...
const config: ERPModulePageConfig = {
  ...
  description: 'Total estimated project cost at completion',
  businessPurpose: 'Actual cost plus forecast to complete gives EAC with variance against budget',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Key cost control metric',
  module: 'construction',
  documentType: 'EAC',
