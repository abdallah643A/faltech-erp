...
const config: ERPModulePageConfig = {
  title: 'Risk Register',
  description: 'Project risk identification and mitigation tracking',
  businessPurpose: 'Structured risk log with probability, impact, mitigation actions, and ownership',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. May trigger contingency allocation',
  module: 'construction',
  documentType: 'Risk',
