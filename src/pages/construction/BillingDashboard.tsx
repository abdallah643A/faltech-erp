...
const config: ERPModulePageConfig = {
  title: 'Billing Status Dashboard',
  description: 'Overview of billing progress and collection',
  businessPurpose: 'Dashboard showing billed vs certified vs collected with aging by project',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Analytical dashboard',
  module: 'construction',
