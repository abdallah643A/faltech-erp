...
const config: ERPModulePageConfig = {
  title: 'Bid Review Sheet',
  description: 'Technical and commercial bid review',
  businessPurpose: 'Structured review of bid before submission with technical and commercial checklists',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Gates tender submission',
  module: 'construction',
  documentType: 'Bid Review',
