...
const config: ERPModulePageConfig = {
  title: 'Cost Ledger',
  description: 'Project cost transaction ledger',
  businessPurpose: 'Complete transaction-level view of all costs posted to the project',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Reporting view of posted costs',
  module: 'construction',
  documentType: 'Ledger Entry',
