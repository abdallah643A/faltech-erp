...
const config: ERPModulePageConfig = {
  title: 'Wastage / Loss Report',
  description: 'Report material wastage and losses',
  businessPurpose: 'Record material wastage, damage, and loss with variance posting',
  financeEffect: 'project_cost',
  financeEffectDescription: 'May create variance posting. Updates project wastage cost tracking',
  financeRegistryKey: 'wastage_report',
  module: 'construction',
