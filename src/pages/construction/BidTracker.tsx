...
const config: ERPModulePageConfig = {
  title: 'Bid Submission Tracker',
  description: 'Track submitted bids and their status',
  businessPurpose: 'Monitor submitted tenders, response deadlines, and award decisions',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Updates win/loss analytics',
  module: 'construction',
  documentType: 'Bid Submission',
