...
const config: ERPModulePageConfig = {
  ...
  description: 'Project margin and profitability analysis',
  businessPurpose: 'Compare contract value with estimated and actual costs to track margin',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Key profitability metric',
  module: 'construction',
