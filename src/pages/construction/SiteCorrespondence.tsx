...
const config: ERPModulePageConfig = {
  title: 'Site Correspondence',
  description: 'Manage project correspondence log',
  businessPurpose: 'Track incoming and outgoing correspondence with clients, consultants, and subcontractors',
  financeEffect: 'none',
