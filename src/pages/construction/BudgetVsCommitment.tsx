...
const config: ERPModulePageConfig = {
  ...
  description: 'Compare budget with committed costs',
  businessPurpose: 'Analyze remaining budget after accounting for all commitments',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Analytical cost control',
  module: 'construction',
