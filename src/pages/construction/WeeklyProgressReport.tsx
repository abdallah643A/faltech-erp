...
const config: ERPModulePageConfig = {
  ...
  description: 'Consolidated weekly progress summary',
  businessPurpose: 'Aggregated weekly metrics from daily reports with variance commentary',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Drives management reporting',
  module: 'construction',
