...
const config: ERPModulePageConfig = {
  ...
  description: 'Formal site instructions and architect instructions',
  businessPurpose: 'Track instructions issued by client, consultant, or project manager',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. May create variation basis',
  module: 'construction',
