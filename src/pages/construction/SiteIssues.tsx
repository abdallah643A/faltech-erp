...
const config: ERPModulePageConfig = {
  title: 'Site Issues Log',
  description: 'Track and resolve site issues',
  businessPurpose: 'Log issues, assign responsibility, track resolution, and link to claims if applicable',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. May support delay claims',
  module: 'construction',
  documentType: 'Issue',
