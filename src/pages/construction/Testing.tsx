...
const config: ERPModulePageConfig = {
  ...
  description: 'System testing and commissioning tracking',
  businessPurpose: 'Track testing activities, results, and sign-offs for all building systems',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Gates handover',
  module: 'construction',
  documentType: 'Test Record',
