...
const config: ERPModulePageConfig = {
  ...
  description: 'Real-time project performance overview',
  businessPurpose: 'Consolidated view of schedule, cost, quality, safety, and billing KPIs',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Aggregates project metrics',
  module: 'construction',
