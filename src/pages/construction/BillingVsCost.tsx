...
const config: ERPModulePageConfig = {
  title: 'Billing vs Cost vs Collection',
  description: 'Compare billing, cost, and collection by project',
  businessPurpose: 'Three-way analysis of revenue billed, cost incurred, and cash collected',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Key project performance report',
  module: 'construction',
  documentType: 'Report',
