...
const config: ERPModulePageConfig = {
  ...
  description: 'Recover client advance payments from billing',
  businessPurpose: 'Deduct advance recovery from progress billing per agreed schedule',
  financeEffect: 'none',
  financeEffectDescription: 'No journal at recovery calc. Applied in AR invoice',
  module: 'construction',
