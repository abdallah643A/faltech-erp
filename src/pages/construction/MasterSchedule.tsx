...
const config: ERPModulePageConfig = {
  ...
  description: 'Project master schedule with critical path',
  businessPurpose: 'Gantt-based schedule with activities, milestones, dependencies, and resource loading',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Drives planning and progress tracking',
  module: 'construction',
