...
const config: ERPModulePageConfig = {
  ...
  description: 'Equipment fuel consumption tracking',
  businessPurpose: 'Record fuel issues by equipment, project, and activity with cost allocation',
  financeEffect: 'project_cost',
  financeEffectDescription: 'Fuel cost allocated to project overhead or equipment cost code',
  module: 'construction',
  documentType: 'Fuel Record',
