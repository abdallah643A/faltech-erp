...
const config: ERPModulePageConfig = {
  ...
  description: 'Key project milestones and completion criteria',
  businessPurpose: 'Define milestones for billing triggers, retention release, and project phase gates',
  financeEffect: 'none',
  financeEffectDescription: 'No journal. Controls milestone billing and phase transitions',
  module: 'construction',
