...
const config: ERPModulePageConfig = {
  ...
  description: 'Approval workflow for tender submission',
  businessPurpose: 'Multi-level approval required before bid submission based on value and risk',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Controls bid submission authorization',
  module: 'construction',
  documentType: 'Tender Approval',
