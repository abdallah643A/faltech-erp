...
const config: ERPModulePageConfig = {
  title: 'Committed Cost Register',
  description: 'Register of all outstanding commitments',
  businessPurpose: 'View all open POs, subcontracts, and reservations creating future cost obligations',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Shows commitment exposure',
  module: 'construction',
