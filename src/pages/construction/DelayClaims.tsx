...
const config: ERPModulePageConfig = {
  title: 'Delay Claims',
  description: 'Manage delay-related claims',
  businessPurpose: 'Prepare and track claims for time and cost impact from delay events',
  financeEffect: 'none',
  financeEffectDescription: 'No journal unless claim becomes approved variation or compensation',
  module: 'construction',
  documentType: 'Delay Claim',
