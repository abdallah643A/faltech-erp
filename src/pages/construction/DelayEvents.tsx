...
const config: ERPModulePageConfig = {
  title: 'Delay Events Log',
  description: 'Record delay events for claim support',
  businessPurpose: 'Structured delay event log with cause, impact, notice status, and EOT link',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Feeds claim and EOT process',
  module: 'construction',
  documentType: 'Delay Event',
