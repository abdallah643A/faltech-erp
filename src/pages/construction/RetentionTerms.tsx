...
const config: ERPModulePageConfig = {
  title: 'Retention Terms',
  description: 'Client and subcontractor retention configuration',
  businessPurpose: 'Define retention percentages, caps, release conditions, and DLP requirements',
  financeEffect: 'none',
  financeEffectDescription: 'No journal at setup. Controls future retention deduction and release logic',
  module: 'construction',
  documentType: 'Retention Terms',
