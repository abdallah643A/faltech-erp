...
const config: ERPModulePageConfig = {
  title: 'Material Issue to Activity',
  description: 'Issue materials from store to project activity',
  businessPurpose: 'Consume materials against specific project activity and cost code',
  financeEffect: 'project_cost',
  financeEffectDescription: 'Cr Inventory / Dr Project Material Cost. Updates actual project cost',
  module: 'construction',
