...
const config: ERPModulePageConfig = {
  title: 'Billing Plan',
  description: 'Project billing schedule and forecast',
  businessPurpose: 'Plan billing milestones, progress billing dates, and expected certification values',
  financeEffect: 'forecast_only',
  financeEffectDescription: 'No journal. Updates cash inflow forecast',
  module: 'construction',
  documentType: 'Billing Plan',
