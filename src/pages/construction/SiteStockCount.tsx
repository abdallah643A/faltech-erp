...
const config: ERPModulePageConfig = {
  title: 'Site Stock Count',
  description: 'Physical stock count at project site',
  businessPurpose: 'Conduct stock counts at site warehouses with variance analysis',
  financeEffect: 'stock_value',
  financeEffectDescription: 'Posting of variances affects inventory valuation and project cost',
  financeRegistryKey: 'site_stock_count',
  module: 'construction',
