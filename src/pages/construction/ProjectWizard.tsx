...
const config: ERPModulePageConfig = {
  ...
  description: 'Step-by-step project setup from contract award',
  businessPurpose: 'Create project master with contract value, BOQ, cost codes, WBS, budget, billing rules, and retention terms',
  financeEffect: 'none',
  financeEffectDescription: 'No immediate journal. Establishes project controlling framework',
  module: 'construction',
