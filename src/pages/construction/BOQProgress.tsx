...
const config: ERPModulePageConfig = {
  title: 'BOQ Progress Entry',
  description: 'Record progress against BOQ items for billing',
  businessPurpose: 'Enter completed quantities against BOQ lines for valuation and billing',
  financeEffect: 'none',
  financeEffectDescription: 'No journal. Drives progress billing calculations',
  module: 'construction',
  documentType: 'BOQ Progress',
