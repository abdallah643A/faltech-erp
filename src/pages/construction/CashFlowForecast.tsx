...
const config: ERPModulePageConfig = {
  ...
  description: 'Project cash inflow and outflow forecasting',
  businessPurpose: 'Forecast based on billing plan, procurement schedule, payroll, and retention release',
  financeEffect: 'forecast_only',
  financeEffectDescription: 'No journal. Feeds treasury planning and financing decisions',
  module: 'construction',
