...
const config: ERPModulePageConfig = {
  title: 'Variation Billing',
  description: 'Bill approved variations to client',
  businessPurpose: 'Include certified variation values in progress billing',
  financeEffect: 'none',
  financeEffectDescription: 'No journal at variation billing stage. Included in AR invoice',
  module: 'construction',
  documentType: 'Variation Bill',
