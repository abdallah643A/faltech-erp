...
const config: ERPModulePageConfig = {
  title: 'Penalty / LD Rules',
  description: 'Liquidated damages and penalty configuration',
  businessPurpose: 'Define penalty rates, caps, grace periods, and exemption conditions',
  financeEffect: 'none',
  financeEffectDescription: 'No journal at setup. Controls penalty deduction in billing',
  module: 'construction',
  documentType: 'Penalty Rule',
