...
const config: ERPModulePageConfig = {
  title: 'Equipment Cost Allocation',
  description: 'Allocate equipment costs to projects',
  businessPurpose: 'Internal charge rates or external rental costs allocated to project cost codes',
  financeEffect: 'project_cost',
  financeEffectDescription: 'Owned equipment creates internal cost allocation. Rented equipment AP invoice creates payable and project cost',
  module: 'construction',
  documentType: 'Equipment Cost',
