...
const config: ERPModulePageConfig = {
  title: 'Tender Result Analysis',
  description: 'Analyze tender outcomes for continuous improvement',
  businessPurpose: 'Track win/loss ratios, margin accuracy, estimation variance, and competitor patterns',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Drives estimation improvement',
  module: 'construction',
