...
const config: ERPModulePageConfig = {
  ...
  description: 'Budget revision history and comparison',
  businessPurpose: 'Track budget revisions from tender estimate through revised budgets and forecasts',
  financeEffect: 'budget',
  financeEffectDescription: 'No journal. Controls budget version lifecycle',
  module: 'construction',
  documentType: 'Budget Version',
