...
const config: ERPModulePageConfig = {
  title: 'Budget vs Actual (Construction)',
  description: 'Compare budget with actual costs incurred',
  businessPurpose: 'Detailed variance analysis between approved budget and actual expenditure',
  financeEffect: 'none',
