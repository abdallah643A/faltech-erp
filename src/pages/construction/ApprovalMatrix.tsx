...
const config: ERPModulePageConfig = {
  title: 'Project Approval Matrix',
  description: 'Role-based approval authority for project transactions',
  businessPurpose: 'Define approval levels by document type, amount threshold, and project role',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Controls transaction authorization',
  module: 'construction',
  documentType: 'Approval Rule',
