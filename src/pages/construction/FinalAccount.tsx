...
const config: ERPModulePageConfig = {
  ...
  description: 'Prepare final project account for settlement',
  businessPurpose: 'Consolidate all variations, claims, retentions, advances, and outstanding items',
  financeEffect: 'journal_entry',
  financeEffectDescription: 'Final billing, retention release, and settlement clearing entries',
  financeRegistryKey: 'final_account',
  module: 'construction',
