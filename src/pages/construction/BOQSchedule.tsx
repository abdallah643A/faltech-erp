...
const config: ERPModulePageConfig = {
  title: 'BOQ Schedule',
  description: 'Schedule of BOQ items for progress measurement and billing',
  businessPurpose: 'BOQ lines linked to activities, cost codes, and billing items for progress-based billing',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Drives progress billing calculations',
  module: 'construction',
  documentType: 'BOQ Schedule',
