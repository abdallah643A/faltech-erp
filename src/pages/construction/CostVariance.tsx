...
const config: ERPModulePageConfig = {
  ...
  description: 'Analyze cost variances by category',
  businessPurpose: 'Identify and explain variances between budget, commitment, and actual by trade and cost code',
  financeEffect: 'none',
