...
const config: ERPModulePageConfig = {
  ...
  description: 'Project manpower requirements and allocation',
  businessPurpose: 'Plan labor requirements by trade, skill, and period against project activities',
  financeEffect: 'none',
  financeEffectDescription: 'No finance effect. Drives recruitment and mobilization planning',
  module: 'construction',
  documentType: 'Manpower Plan',
