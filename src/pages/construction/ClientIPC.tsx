...
const config: ERPModulePageConfig = {
  title: 'Client IPC / Valuation',
  description: 'Interim Payment Certificate and work valuation',
  businessPurpose: 'Prepare work valuation with certified quantities, variations, materials on site',
  financeEffect: 'none',
  financeEffectDescription: 'No journal at valuation stage. Feeds progress billing',
  financeRegistryKey: 'client_ipc',
  module: 'construction',
  documentType: 'IPC',
