...
const config: ERPModulePageConfig = {
  title: 'Construction Leads & Opportunities',
  description: 'Manage pre-tender leads and opportunity pipeline',
  businessPurpose: 'Track potential project opportunities from initial contact to tender invitation',
  financeEffect: 'none',
  financeEffectDescription: 'No direct finance effect. Updates pipeline forecast and expected revenue',
  module: 'construction',
  documentType: 'Lead',
